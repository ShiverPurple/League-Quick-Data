...
searchButton = tkinter.Label(searchButtonBorder, text = "SEARCH", font = ("", 8, "bold"), background = "black", foreground = "white", borderwidth = 3)
...
player1 = tkinter.Entry(root, width = 22, background = "black", foreground = "white", borderwidth = 0, highlightthickness = 2, 
highlightcolor = "#775829", highlightbackground = "#775829", insertbackground = "light grey", insertborderwidth = 1, relief= "ridge")
player1.grid(row = 1, column = 0, sticky = "we")

player2 = tkinter.Entry(root, width = 22, background = "black", foreground = "white", borderwidth = 0, highlightthickness = 2, 
highlightcolor = "#775829", highlightbackground = "#775829", insertbackground = "light grey", insertborderwidth = 1, relief= "ridge")
player2.grid(row = 1, column = 1, sticky = "we")

player3 = tkinter.Entry(root, width = 22, background = "black", foreground = "white", borderwidth = 0, highlightthickness = 2, 
highlightcolor = "#775829", highlightbackground = "#775829", insertbackground = "light grey", insertborderwidth = 1, relief= "ridge")
player3.grid(row = 1, column = 2, sticky = "we")

player4 = tkinter.Entry(root, width = 22, background = "black", foreground = "white", borderwidth = 0, highlightthickness = 2, 
highlightcolor = "#775829", highlightbackground = "#775829", insertbackground = "light grey", insertborderwidth = 1, relief= "ridge")
player4.grid(row = 1, column = 3, sticky = "we")

player5 = tkinter.Entry(root, width = 22, background = "black", foreground = "white", borderwidth = 0, highlightthickness = 2, 
highlightcolor = "#775829", highlightbackground = "#775829", insertbackground = "light grey", insertborderwidth = 1, relief= "ridge")
...
def CreateHistoryFrame(playerNumber):
    ...
    scrollableFrame = tkinter.Frame(root, height = 500, width = 680, background = "black")
    scrollableFrame.grid(row = 4, columnspan = 5, sticky = "nsew")
    scrollableFrame.grid_columnconfigure((0, 1), weight = 1)

    canvasLayout = tkinter.Canvas(scrollableFrame, height = 500, width = 680, background = "black", highlightthickness = 0, scrollregion = (0, 0, 0, 960))
    canvasLayout.grid(row=0, column = 0, sticky = "nsew")
    
    historyFrame = tkinter.Frame(canvasLayout, height = 500, width = 680, background = "black")
        ...
        for i in range(3):
            ...
            try:
                ...
                if response.status_code == 200:
                    with open(f"datadragon/{self.championDictOrder[i][0]}.png", 'wb') as f:
...
class MatchStatsChampion:
    ...
    def MatchStatsChampionRequest(self, matchRawData, playerKey, player):
        ...
        try:
            ...
            if response.status_code == 200:
                with open(f"datadragon/{self.championId}.png", 'wb') as f:
                    f.write(response.content)
        ...
        for i in range(2):
            ...
            if self.spellSpriteName[i] != 0:
                try:
                    ...
                    if response.status_code == 200:
                        with open(f"datadragon/{self.spellSpriteName[i]}.png", 'wb') as f:
                            f.write(response.content)
        ...
        for i in range(7):
            ...
            if self.itemArray[i] != 0:
                try:
                    ...
                    if response.status_code == 200:
                        with open(f"datadragon/{self.itemArray[i]}.png", 'wb') as f:
                            f.write(response.content)
...
class MatchStatsGame:
    ...
    def GetMatchResult(self, matchRawData, playerKey):
        ...
        self.matchResult = "VITORIA" if matchRawData["info"]["participants"][participants.index(playerKey)]["win"] else "DERROTA"
...
class MatchPreview:
    ...
    def GamemodeResult(frameNumber, matchResult, gameMode, spellArray, preview):
        ...
        foreground = "red" if matchResult == "DERROTA" else "deep sky blue", borderwidth = 0, font = ("", 10, "bold")) #text = matchResult/gameMode
    ...
    for i in range(5):
        ...
        if playerArray[i].get() != "" and " ":
            ...
            if playerStatsArray[i].PlayerDataRequest(playerArray[i].get()) == 0:
                ...
                playerStatsArray[i].PlayerDataRequest(playerArray[i].get())

                MatchListDataRequest(playerStatsArray[i].playerPuuid, i)
